  ...
  return (
    <div className="reviewBlockContent">
      <div className="reviewScoreLine">
        ...
        <span>答对 {correctCount} 个目标词</span>
      </div>
      ...
      <div className="reviewBingoTargets">
        <span className="reviewBingoTargetsLabel">正确答案：</span>
...
function ReviewQuizBlock({ results, questions }: { results: GameResult[]; questions: Question[] }) {
  ...
  return (
    <div className="reviewBlockContent">
      <div className="reviewScoreLine">
        <span>总分：<b>{results.reduce((s, r) => s + r.score, 0)}</b> / 100</span>
      </div>
...
export default function ReviewPage() {
  ...
  if (!player) {
    return (
      <Layout title="温故知新" hideHeader>
        <section className="reviewPage">
          <PageBackground />
          <div className="reviewPageContent">
            <p className="reviewLoading">正在读取身份...</p>
          </div>
        </section>
      </Layout>
    );
      ...
      <section className="reviewPage">
        ...
        <div className="reviewPageContent">
          ...
          {gamesWithResults.length === 0 ? (
            <div className="reviewEmpty">暂无已完成的游戏记录</div>
          ) : (
              ...
              return (
                <div className="reviewBlock" key={key}>
                  <div className="reviewBlockHeader">
                    <span className="reviewBlockTitle">{GAME_LABELS[key]}</span>
                  </div>
